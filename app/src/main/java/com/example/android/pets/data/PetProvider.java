...
public class PetProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(PetContract.CONTENT_AUTHORIY, PetContract.PATH_PETS, PETS);
        sUriMatcher.addURI(PetContract.CONTENT_AUTHORIY, PetContract.PATH_PETS + "/#", PET_ID);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                break;
            default:
                throw new IllegalArgumentException("Cannot resolve unknoen uri " + uri);
        }
